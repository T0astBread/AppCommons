package cc.t0ast.appcommons.apicom;
...
public class JsonHttpApiCommunicator
{
    ...
    public <T> T request(RequestParams params) throws IOException
    {
        ...
        if(params.hasOutputType())
        {
            ...
            return parseApiResponseIfNeeded(response, params);
        }
        else return null;
    }

    private <T> T parseApiResponseIfNeeded(String response, RequestParams params)
    {
        return params.getOutputType() == String.class ? (T) response : getGsonToUse(params).fromJson(response, params.getOutputType());
    }

    private Gson getGsonToUse(RequestParams params)
    {
        return params.hasGsonInstanceToUse() ? params.getGsonInstanceToUse() : gson;
    }
    ...
    public static class RequestParams
    {
        ...
        private Gson gsonInstanceToUse;
        ...
        public boolean hasGsonInstanceToUse()
        {
            return this.gsonInstanceToUse != null;
        }

        public Gson getGsonInstanceToUse()
        {
            return gsonInstanceToUse;
        }

        public void setGsonInstanceToUse(Gson gsonInstanceToUse)
        {
            this.gsonInstanceToUse = gsonInstanceToUse;
        }
    }
}
